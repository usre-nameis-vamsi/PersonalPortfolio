...
const AboutMe = () => {
  ...
  return (
    <section className="pb-section" id="about-me">
      <div className="pl-[8%] pr-[4%] w-full" ref={container}>
        <h2 className="text-4xl md:text-6xl font-thin mb-20 slide-up-and-fade text-left">
  ...
  <p className="text-4xl slide-up-and-fade whitespace-nowrap">
  Hi, I&apos;m <span className="text-green-400 font-semibold">Vamsi Chanumolu</span>.
</p>
